...
#pragma - View
/*
 * Before Loading the Scene, set the HSV Values and set up the switch
 */
- (void)viewDidLoad {
    [super viewDidLoad];
...
/*
 * Set's the hue, saturation, and value for all the green infrastructure icons.
 */
- (void) setHSVValues {
    int hsvValues[30];
...
/*
 * Change the values based on which the case number.
 */
